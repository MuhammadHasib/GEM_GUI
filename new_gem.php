...
<?php
$serial_num_of_newest_part = get_part_ID('10000000000001659');
                        ...
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            ...
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    ...
                                    <div class="serial"><span class="name">FOIL-B1-</span><span id="vers" ><?= $serial_num[2]; ?></span><span class="id">-<?= str_pad($serial_num[3] + 1, 4, 0, STR_PAD_LEFT); ?></span></div>
...
<script>
    $(document).ready(function () {
         ...
         */
        $.ajax({
            url: 'functions/ajaxActions.php?kindid=10000000000001659',
        ...
        function ajaxCall() {
            if ($("#vers").text() == "L-") {
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=10000000000001659&version=-L-',
                ...
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=10000000000001659&version=-S-',
                    success: function (data) {
                        $(".id").text(data);
                        $(".serialInput").val($(".serial").text());
                    }
