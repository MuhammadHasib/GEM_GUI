...
<?php
  ...
  include "side.php";
  ?>                               DELETE THOSE // SLASHES TWO LINES ABOVE !!!!!!!!!!!!
<html>
<head>
	<?php // DELETE FROM HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		

		$json=shell_exec("python rhapi.py -u http://gem-machine-a:8113 'select * from gem_omds.c1840 c' -s 100 -f json");
		//$json=shell_exec("python rhapi.py -u http://gem-machine-a:8113 'select * from gem_omds.c1840 c' -s 20 ");
