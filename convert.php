...
$output = shell_exec("/afs/cern.ch/user/h/hamd/www/dev/my_env/bin/python QC3_Data_SERVER_COPY.py $FileName $RUN_NUMBER $LOCATION $INITIATED_BY_USER $COMMENT_DESCRIPTION $RUN_BEGIN_TIMESTAMP $RUN_END_TIMESTAMP $ELOG $FILE $COMMENT ");
