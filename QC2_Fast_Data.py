...
def xml_from_excel2(excel_file):
	...
	root = generateXMLHeader("FOIL_QC2_LONG_AMB_CON","GEM Foil QC2 Fast Test Condition","CERN MPT GEM Foil QC2 Fast Test Data",Run,Start,Stop,comment,location,user)
	...
	root = generateXMLHeader("FOIL_QC2_FAST_TES","GEM Foil QC2 Fast Test Data","GEM Foil QC2 Fast Test Data",Run,Start,Stop,comment,location,user)
	dataSet = generateDataSet(root,Comment,"1","GEM Foil",foil)
...
if __name__ =="__main__":	
	...
	fileName=fname+".xml"
	testfile=fname+"_amb"+"_summry.xml"
