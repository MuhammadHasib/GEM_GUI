...
<?php
//$outs = trim($out);
$output = shell_exec("/afs/cern.ch/user/h/hamd/www/dev/my_env/bin/python QC_Data_SERVER_COPY.py $FileName $outs $LOCATION $INITIATED_BY_USER '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP' '$Elog' '$Files' '$comments' ");
