...
def xml_from_excel4(excel_file):
	...
	Comment=sys.argv[11]
	Run=sys.argv[3]
	root = generateXMLHeader("QC4_HVTEST_CONFIG","GEM Chamber QC4 HVTEST Configuration","CERN Station A GEM QC4 HV Test",Run,Start,Stop,comment,location,user)
	...
	Elog=sys.argv[9]
	#Comment=sys.argv[11]
	root = generateXMLHeader("QC4_HVTEST_SUMRY","GEM Chamber QC4 HVTEST Summary","CERN Station A GEM QC4 HV Test Summary",Run,Start,Stop,comment,location,user)
	dataSet = generateDataSet(root,Comment,"1","GEM Chamber",chamber)
