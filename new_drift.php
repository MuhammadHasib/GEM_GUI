...
<?php
$serial_num_of_newest_part = get_part_ID('10000000000001599');
                        ...
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            ...
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    ...
                                    <div class="serial"><span class="name">PCB-DR-B<span class="batch">1</span>-<span id="vers" ><?= $serial_num[3]; ?></span><span class="id">-<?= str_pad($serial_num[4] + 1, 4, 0, STR_PAD_LEFT); ?></span></div>
...
<script>
    $(document).ready(function () {
         ...
         */
        $.ajax({
            url: 'functions/ajaxActions.php?kindid=10000000000001599',
        ...
        function ajaxCall() {
            if ($("#vers").text() == "L-") {
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=10000000000001599&version=-L-',
                ...
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=10000000000001599&version=-S-',
                    success: function (data) {
                        $(".id").text(data);
                        $(".serialInput").val($(".serial").text());
                    }
