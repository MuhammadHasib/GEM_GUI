...
<div class="container-fluid" >
    <div class="row">
      ...
      <strong>Well done!</strong> You successfully created GEM Electronic Board GEB <strong>ID:</strong> ' . $_POST['serial'] .
                    '</div>';
                        ...
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            ...
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    ...
                                    <div class="serial"><span class="name">GEB-RO-</span><span id="vers" ><?= $serial_num[2]; ?></span><span class="id">-<?= str_pad($serial_num[3] + 1, 4, 0, STR_PAD_LEFT); ?></span></div>
