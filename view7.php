...
<!--      <a href="Homes.php" style="color: floralwhite; font-family: Calibri; font-size: large;">Home</a>-->
  ...
  <option value="GE1/1-SCS-01">GE1/1-SCS-01</option>
  <option value="GE1/1-SCS-02">GE1/1-SCS-02</option>
  <option value="GE1/1-SCS-03">GE1/1-SCS-03</option>
  <option value="GE1/1-SCL-01">GE1/1-SCL-01</option>
  <option value="GE1/1-SCL-02">GE1/1-SCL-02</option>
  </select>
  <br>
  ...
  <div id="t">
    ...
    $p=$_POST['posn'];
    $s=$_POST['sprchbrid'];
    $q="Select SPER_CHMBR_SER_NUM,CHMBR_SER_NUM,DEPTH,DRIFT_PCB,GEM_FOIL,FOIL_POSN,RDOUT_PCB from CMS_GEM_MUON_VIEW.GEM_SPRCHMBR_PARTS_VIEW WHERE ";
